...
'game_name' => "My Shelfie",

// Game designer (or game designers, separated by commas)
'designer' => 'Phil Walker-Harding,Matthew Dunstan',       

// Game artist (or game artists, separated by commas)
'artist' => ' Shannon Elizabeth Grosenbacher,Sara Valentino',         
...
'tie_breaker_description' => clienttranslate("The tied player sitting further (clockwise) from the player holding the first player seat wins the game"),
...
'presentation' => array(
    totranslate("Rejoice, it’s time to reorganize your library and put your favorite objects back in place! Will you be able to do it faster than other players, satisfying the required patterns?"),
    totranslate("Pick tiles from the living room, insert them in your Shelf, making them fall from the top, while trying to recreate the patterns of your personal or common target. An eye-catcher and strategy game with easy rules and tons of replayability."),
//    ...
),
